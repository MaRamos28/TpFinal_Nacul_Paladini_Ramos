...
def dibujar_grilla(cant_filas, cant_columnas, tamaño_celda, color1, color2, borde, ventana):
...
def colocar_planta(fila, columna, planta_seleccionada, grilla, lista_plantas, cant_filas, cant_columnas, img_girasol, img_lanzaguisante, img_nuez):
